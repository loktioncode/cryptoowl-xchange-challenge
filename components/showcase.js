...
export default function ShowcaseCollection() {
  ...
  return (
    <>
      ...
      <section className="p-4 lg:p-8 dark-custom" id="learnmore" >
        <div className="container mx-auto space-y-12">
          <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
            <div className="flex items-center justify-center flex-1 bg-blue-600">
              <ProfilePicture />
            </div>
          ...
          <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
            <div className="flex items-center justify-center flex-1 bg-blue-600">
              <img src="assets/svg/selectcolor.svg" alt="" className="p-8 h-60 bg-coolGray-500"></img>
            </div>
            <div className="flex flex-col justify-center flex-1 px-6 py-12 bg-coolGray-50">
              <span className="text-xs uppercase text-coolGray-600">Join, it's free</span>
              <h2 className="text-3xl font-bold">We're not reinventing the wheel</h2>
              <p className="my-6 text-coolGray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor aliquam possimus quas, error esse quos.</p>
              <button type="button" className="self-start bg-blue-600 hover:bg-blue-700 focus:ring-blue-500 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg">Action</button>
            </div>
          </div>
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            ...
            <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-coolGray-800 text-coolGray-100">
              ...
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                <a href="#" title="Email" className="text-coolGray-50 hover:text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                  </svg>
                </a>
                <a href="#" title="Twitter" className="text-coolGray-50 hover:text-blue-600">
                ...
                <a href="#" title="LinkedIn" className="text-coolGray-50 hover:text-blue-600">
                ...
                <a href="#" title="GitHub" className="text-coolGray-50 hover:text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
