    ...
    <>
      ...
      <div class="relative bg-white overflow-hidden">
                    ...
                    <div class="flex items-center justify-between w-full md:w-auto">
                      <a href="#">
                        ...
                        <Image
                          height={50}
                          width={100}
                          class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg"
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <Image layout='fill'
            class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80" alt=""
          />
